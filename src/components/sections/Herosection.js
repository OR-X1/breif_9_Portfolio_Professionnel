  ...
  return (
    ...
    >
      <div className="container">
        <div className="intro">
          <img src="./images/profil.png" width={108}   alt="Bolby" className="mb-4 rounded-circle" />

          <h1 className="mb-2 mt-0">Youssef Elbakkouri</h1>
          <p>
            I'm a{" "}
            <Typed
              strings={[
              ...
              typeSpeed={80} backSpeed={40} attr="value" loop
            >
              <label value></label>
            </Typed>
          </p>
